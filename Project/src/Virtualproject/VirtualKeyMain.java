...
class FileOptionsMenu implements Screen {
	...
	public void DeleteFile() {
		...
		if (file.delete()) {
			...
			System.out.println("error occurs in  deleting:" + fileName );
		}
	}
...
class WelcomeScreen implements Screen {
	...
	private String welcomeText = "Simplilearn  Phase 1 Project - Virtual Key Repoistory ";
	private String developerText = " Developer: Abinaya R ";
	private ArrayList<String> options = new ArrayList<>();
